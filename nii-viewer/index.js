...
// end include: /tmp/tmp6m21rkrk.js
// include: /tmp/tmpttfkq80p.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpttfkq80p.js
// include: /tmp/tmpfd4bubv7.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpfd4bubv7.js
...
var ASM_CONSTS = {
  88756: ($0) => { if (window.updateMinThresholdSlider) { window.updateMinThresholdSlider($0); } },  
 88838: ($0, $1) => { if (window.updateClippingSlider) { window.updateClippingSlider($0, $1); } },  
 88916: () => { if (window.triggerNiftiFileSelect) { window.triggerNiftiFileSelect(); } }
};
...
var _nii_set_min_threshold = Module['_nii_set_min_threshold'] = makeInvalidEarlyAccess('_nii_set_min_threshold');
var _nii_set_max_threshold = Module['_nii_set_max_threshold'] = makeInvalidEarlyAccess('_nii_set_max_threshold');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['nii_set_min_threshold'] != 'undefined', 'missing Wasm export: nii_set_min_threshold');
  assert(typeof wasmExports['nii_set_max_threshold'] != 'undefined', 'missing Wasm export: nii_set_max_threshold');
  ...
  _nii_set_min_threshold = Module['_nii_set_min_threshold'] = createExportWrapper('nii_set_min_threshold', wasmExports['nii_set_min_threshold'], 1);
  _nii_set_max_threshold = Module['_nii_set_max_threshold'] = createExportWrapper('nii_set_max_threshold', wasmExports['nii_set_max_threshold'], 1);
